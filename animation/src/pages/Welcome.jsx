...
export default function WelcomePage() {
    ...
    const {scrollY} = useScroll() // 사용자가 스크롤을 내린 픽셀수

    //픽셀에서 애니메이션에 이용할 수 있게 값이 변환 되어야하는 값을 지정한다.
    //뒷단에서 애니메이션 컴포넌트 렌더링 사이클에 영향을 미치지 않도록 관리해준다.(컴포넌트 자체가 재실행 되지 않는다.)
    ...
    return (
        <>
            <header id="welcome-header">
                ...
                <motion.img
                    style={{opacity: opacityCity, y: yCity}}/*framer-motion이 자동으로 애니메이션을 플레이해준다.*/
                    src={cityImg}
